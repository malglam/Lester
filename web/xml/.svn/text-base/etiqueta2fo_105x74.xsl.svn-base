...
<fo:table-cell keep-together.within-page="always" width="100mm" border="1px solid gray" min-height="72mm">
        ...
        <fo:table-body>
            <fo:table-row>
                <fo:table-cell number-columns-spanned="3"  >
                    <fo:block overflow="hidden" font-size="18pt" font-weight="bold" text-align="center">
            ...
            <fo:table-row>
                ...
                <fo:table-cell>
                    <fo:block overflow="hidden" font-size="10pt" text-align="center">
                        Frases H
                    </fo:block>
                </fo:table-cell>
            </fo:table-row>
            <fo:table-row>
                <fo:table-cell >
                    <fo:block overflow="hidden" font-size="10pt" text-align="center" font-weight="bold"   >
            ...
            <fo:table-row>
                <fo:table-cell number-columns-spanned="3">
                    <fo:block overflow="hidden" font-size="14pt" font-weight="bold" text-align="center">
...
<xsl:template match="pictogramas">
        <fo:block font-size="10pt" text-align="center">
           <xsl:for-each select="pictograma">
                ...
                <fo:external-graphic content-width="90px" content-height="90px" src="url({$base_path}/{$fich})"/>
           </xsl:for-each> 
        </fo:block>
